...
export type BlockDocument = (Events | EventsItem | Home | _AgentSTART | eventsItem_AsList) & { __isUnion?: true }
...
export type BlockList = (Events | eventsItem_AsList) & { __isUnion?: true }
...
export type EventsItemOrderByEnum = '_sys_createdAt__ASC' | '_sys_createdAt__DESC' | '_sys_hash__ASC' | '_sys_hash__DESC' | '_sys_id__ASC' | '_sys_id__DESC' | '_sys_lastModifiedAt__ASC' | '_sys_lastModifiedAt__DESC' | '_sys_slug__ASC' | '_sys_slug__DESC' | '_sys_title__ASC' | '_sys_title__DESC' | 'date__ASC' | 'date__DESC' | 'link__ASC' | 'link__DESC' | 'time__ASC' | 'time__DESC'
...
export interface _components {
    eventsItem: eventsItem_AsList
    __typename: '_components'
}

export interface eventsItem_AsList {
    _analyticsKey: Scalars['String']
    _dashboardUrl: Scalars['String']
    _id: Scalars['String']
    _idPath: Scalars['String']
...
export interface BlockDocumentGenqlSelection{
    ...
    on_Events?: EventsGenqlSelection
    on_EventsItem?: EventsItemGenqlSelection
    on_Home?: HomeGenqlSelection
    on__AgentSTART?: _AgentSTARTGenqlSelection
    on_eventsItem_AsList?: eventsItem_AsListGenqlSelection
    __typename?: boolean | number
}
...
export interface EventsGenqlSelection{
    ...
    _title?: boolean | number
    /** Returns the first item in the list, or null if the list is empty. Useful when you expect only one result. */
    item?: EventsItemGenqlSelection
    /** Returns the list of items after filtering and paginating according to the arguments sent by the client. */
    items?: EventsItemGenqlSelection
    __typename?: boolean | number
}

export interface EventsItemGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
...
export interface EventsItemFilterInput {AND?: (EventsItemFilterInput | null),OR?: (EventsItemFilterInput | null),_id?: (StringFilter | null),_slug?: (StringFilter | null),_sys_apiNamePath?: (StringFilter | null),_sys_createdAt?: (DateFilter | null),_sys_hash?: (StringFilter | null),_sys_id?: (StringFilter | null),_sys_idPath?: (StringFilter | null),_sys_lastModifiedAt?: (DateFilter | null),_sys_slug?: (StringFilter | null),_sys_slugPath?: (StringFilter | null),_sys_title?: (StringFilter | null),_title?: (StringFilter | null),date?: (StringFilter | null),link?: (StringFilter | null),time?: (StringFilter | null)}
...
export interface HomeGenqlSelection{
    ...
    events?: (EventsGenqlSelection & { __args?: {
    /** Filter by a field. */
    filter?: (EventsItemFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
    /** Order by a field. */
    orderBy?: (EventsItemOrderByEnum | null), 
...
export interface _componentsGenqlSelection{
    eventsItem?: (eventsItem_AsListGenqlSelection & { __args?: {
    /** Filter by a field. */
    filter?: (EventsItemFilterInput | null), 
    /** Limit the number of items returned. Defaults to 500. */
    first?: (Scalars['Int'] | null), 
...
export interface eventsItem_AsListGenqlSelection{
    _analyticsKey?: { __args: {
    /**
     * The scope of the analytics key. Use `send` for just ingesting data. Use `query` if you need to show an analytics data in your website.
     * 
...
export interface FragmentsMap {
  ...
  Events: {
    root: Events,
    selection: EventsGenqlSelection,
}
  EventsItem: {
    root: EventsItem,
    selection: EventsItemGenqlSelection,
}
  GetUploadSignedURL: {
  ...
  eventsItem_AsList: {
    root: eventsItem_AsList,
    selection: eventsItem_AsListGenqlSelection,
}
}
